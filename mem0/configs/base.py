...
class MemoryItem(BaseModel):
    ...
    score_details: Optional[Dict[str, Any]] = Field(
        None, description="Scoring breakdown attached when explain=True"
    )
    degraded_from_hybrid: Optional[bool] = Field(
        None, description="True when the result came from a degraded pool (semantic lane failed)"
    )
